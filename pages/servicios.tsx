	...
	return (
		<Layout>
			...
			<main className="relative w-screen">
				<h2 className="capitalized mx-auto max-w-md pt-28 text-center font-poppins text-4xl font-[500] text-gray-700 underline decoration-yellow md:max-w-2xl md:text-6xl">
					Servicios
				</h2>
