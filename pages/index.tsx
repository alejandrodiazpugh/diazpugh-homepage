...
export default function Home({ servicesData, cardData }: Props) {
  return (
    <Layout>
      ...
      <article
        id="hero"
        className="relative z-50 grid min-h-screen w-screen snap-y snap-mandatory grid-cols-2 flex-col-reverse"
      >
        <motion.div className="col-span-2 col-start-1 mx-10 flex flex-col justify-center lg:col-span-1 lg:mx-0">
          <h1 className="capitalized mx-auto max-w-md snap-y snap-mandatory pt-28 text-center font-poppins text-4xl font-[500] text-gray-800 md:max-w-2xl md:text-7xl">
            ...
            <span className="underline decoration-blue">experiencia web</span>
          </h1>
      ...
      <article className="mx-auto flex h-56 w-screen items-center justify-center gap-10 bg-pink shadow-sm">
        <h3 className="basis-96 text-center font-poppins text-xl text-gray-700">
          Revisa los paquetes que te ofrezco, y empecemos a trabajar juntos.
        </h3>
        <div className="flex basis-72 justify-center">
          <Link href={"/servicios"}>
            <button className="w-24 rounded-lg border-2 border-orange bg-orange p-2 font-sourceCode text-white shadow-md transition-all hover:scale-105 hover:border-orange hover:bg-white hover:text-gray-700 active:scale-95">
              Servicios
            </button>
          </Link>
        </div>
      ...
      <article className="max-w-2x relative m-auto">
        ...
        <div className="my-10 mx-auto flex max-w-lg flex-col gap-5 text-center">
          <div className="mx-10 flex flex-col gap-8 font-sourceCode text-xl text-gray-700 lg:mx-0">
            <p>
              Necesitas un espacio virtual. Algo que sea tuyo. Un dominio para
              tu negocio, una tienda en linea, una invitación virtual para tu
              evento.
            </p>
            <p>
              Tal vez ya tienes tu paleta de colores mapeada, o inspiración de
              qué quieres y necesitas hacer. Tal vez llevas meses con la idea
              inicial en tu cabeza, refinándola.
            </p>
      ...
      <article className="mx-10 lg:mx-10">
        <h2 className="mx-auto max-w-md pb-5 pt-28 text-center font-poppins text-2xl font-[500] text-gray-700 md:max-w-2xl md:text-4xl">
          Si tienes alguna duda, déjame tus datos, y me pondré en contacto
          contigo.
        </h2>
        <EmailDropContact />
      </article>
